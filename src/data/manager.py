...
Обеспечивает взаимодействие с базой данных и временным хранилищем сообщений.
"""
...
class DataManager:
    ...
    Обеспечивает взаимодействие между обработчиками и базой данных.
    """

    def __init__(self) -> None:
        """Инициализирует менеджер данных с подключением к БД и хранилищем сообщений."""
        self.db = Database()
